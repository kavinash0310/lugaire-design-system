 ...
 * product, 5 colorways, and 6 sizes. The homepage surfaces only the six
 * "signature" pieces; the Shop page exposes the full catalog.
 */
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    colors: c("Onyx", "Bone", "Camel", "Slate"),
    sizes: allSizes,
  ...
  },
  {
    ...
    colors: c("Onyx", "Slate", "Camel", "Bone"),
    sizes: allSizes,
    images: [IMG.trouser, IMG.fabricWool],
    year: 2025,
  },
  ...
  },
  {
    ...
    colors: c("Bone", "Slate", "Onyx", "Camel"),
    sizes: allSizes,
